...
<ul class = "rn_CategoryExplorerList">
    <? foreach ($children as $key => $categoryValue):?>
        ...
        <? else: ?>
            <li class="rn_CategoryExplorerItem">
                <a id="rn_<?=$this->instanceID;?>_<?=$categoryValue->referenceKey;?>_Expanded" class="rn_CategoryExplorerExpandedHidden" href="javascript:void(0)"><span class="rn_ScreenReaderOnly"><?=$this->data['attrs']['label_expand_icon']?></span></a>
                <a id="rn_<?=$this->instanceID;?>_<?=$categoryValue->referenceKey;?>_Collapsed" class="rn_CategoryExplorerCollapsed" href="javascript:void(0)"><span class="rn_ScreenReaderOnly"><?=$this->data['attrs']['label_collapse_icon']?></span></a>
