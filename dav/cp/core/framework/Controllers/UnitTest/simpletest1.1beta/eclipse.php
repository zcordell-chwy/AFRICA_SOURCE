 ...
 *  @package    SimpleTest
 *  @subpackage Eclipse
 *  @version    $Id: eclipse.php,v 1.1 2012/05/04 00:16:18 jwatson Exp $
 */
/**#@+
 * simpletest include files
 */
include_once __DIR__ . '/unit_tester.php';
include_once __DIR__ . '/test_case.php';
include_once __DIR__ . '/invoker.php';
include_once __DIR__ . '/socket.php';
include_once __DIR__ . '/mock_objects.php';
/**#@-*/
