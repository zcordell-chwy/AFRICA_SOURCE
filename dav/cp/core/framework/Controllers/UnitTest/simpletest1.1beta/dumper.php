 ...
 *  @version    $Id: dumper.php,v 1.1 2012/05/04 00:16:18 jwatson Exp $
 */
/**
 * does type matter
 */
...
class SimpleDumper {
    ...
    function describeValue($value) {
        ...
        switch($type) {
            ...
            case "String":
                return "String: " . $this->clipString($value, 500);
            default:
                return "$type: $value";
        }
        return "Unknown";
    ...
    protected function describeStringDifference($first, $second, $identical) {
        ...
        $message .= " with [" .
                $this->clipString($first, 500, $position) . "] and [" .
                $this->clipString($second, 500, $position) . "]";
        return $message;
    }
