<rn:meta title="Ask the Community" template="mobile.php" login_required="true" clickstream="question_create"/>
...
<div class="rn_PageContent rn_AskQuestion rn_Container">
    ...
    <rn:condition is_social_user="false" is_active_social_user="true">
        ...
        <form id="rn_QuestionSubmit" method="post" action="/ci/ajaxRequest/sendForm">
            ...
            <rn:widget path="input/TextInput" name="SocialQuestion.Body" label_input="#rn:msg:QUESTION_LBL#" required="true"/>
            <rn:widget path="input/MobileProductCategoryInput" name="SocialQuestion.Product" verify_permissions="Create"/>
