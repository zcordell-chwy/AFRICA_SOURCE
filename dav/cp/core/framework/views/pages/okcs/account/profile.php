...
<div class="rn_PageContent rn_Profile rn_Container">
    ...
    <form id="rn_CreateAccount" onsubmit="return false;">
        ...
        <rn:condition external_login_used="false" is_social_user="false" is_active_social_user="true">
            <rn:widget path="input/FormSubmit" label_button="#rn:msg:SAVE_CHANGE_CMD#" on_success_url="none" label_on_success_banner="#rn:msg:PROFILE_HAS_BEEN_UPDATED_MSG#" error_location="rn_ErrorLocation"/>
        </rn:condition>
    </form>
</div>
