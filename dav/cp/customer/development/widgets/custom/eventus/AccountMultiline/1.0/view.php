...
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
    ...
    <div id="rn_<?=$this->instanceID;?>_Content" class="rn_Content">
        ...
        <? if ($value[2] == "Active" || $value[2] == "Manual Pay" || $value[2] == "On Hold - Non Payment" || $value[2] == "Special Hold"){?>
        ...
        <? foreach ($this->data['reportData']['data'] as $value): ?>
            <? if ($value[2] != "Active" && $value[2] != "Manual Pay" && $value[2] && $value[2] !="On Hold - Non Payment" && $value[2] != "Special Hold"){?>
            <rn:block id="resultListItem">
            <div class="listElement">
                <div class="topContent">
        ...
        <? else: 
            echo "<p style='color: red;padding-bottom: 10px;'>No Pledges Available</P>";
