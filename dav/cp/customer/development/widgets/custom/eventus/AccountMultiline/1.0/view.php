                    ...
                    <div class="PledgeStatus <?=$class?> ">
                        <ul>
                            ...
                            <li class="paymethodInfo <?=$payClass?>">
                                <?=$value[22]?><?=($value[23])? "  $value[23]/$value[24]":""?>  <a id="changeMethodLink" name="changeMethodLink" href=/app/account/transactions/c_id/<?=getUrlParm('c_id')?>/p_id/<?=$value[3];?>>Change...</a>
                            </li>
                            <?}?>
                        </ul>
                        <? if ($value[2] == "Active" || $value[2] == "Manual Pay" || $value[2] == "On Hold - Non Payment"){?>
