RightNow.namespace('Custom.Widgets.login.AccountDropdn');
Custom.Widgets.login.AccountDropdn = RightNow.Widgets.AccountDropdown.extend({     /**
    ...
    overrides: {
        /**
         * Overrides RightNow.Widgets.AccountDropdown#constructor.
         */
         ...
         * Overridable methods from AccountDropdown:
         *
         * Call `this.parent()` inside of function bodies
         * (with expected parameters) to call the parent
         * method being overridden.
         */        // _onKeydown: function(e)        // _closeDropdownKeypress: function (e)        // _dropdownNavKeypress: function (e)        // _focusAdjacentElement: function (nodeList, adjacentIndex)        // _indexOfActiveNode: function(nodeList)        // _toggleDropdown: function(evt)        // _openDropdown: function()        // _closeDropdown: function()
    },
    /**
