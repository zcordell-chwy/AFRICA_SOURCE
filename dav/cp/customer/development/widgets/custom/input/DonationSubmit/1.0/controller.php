...
class DonationSubmit extends \RightNow\Widgets\FormSubmit
{
...
*/
    ...
    function afterTransactionDonationCreation($paymethod)
    {
        ...
        try
        {
            ...
            // $this->CI->session->setSessionData(array("fund_id" => \RightNow\Utils\Url::getParameter('f_id')));
            logMessage("FUND ID  >>: " . print_r(\RightNow\Utils\Url::getParameter('f_id'), true));
