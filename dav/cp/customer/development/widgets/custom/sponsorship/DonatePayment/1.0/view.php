<div id="rn_<?= $this->instanceID ?>" class="<?= $this->classList ?>">
            ...
            <form id='storedMethodForm' onsubmit="return false;" autocomplete="off">
                <rn:condition logged_in="true">
                    <div class="rn_BillingDonorInfoContainer">
                        ...
                        <div>
                            <rn:widget path="custom/payment/DonatePaymentProcess" on_success_url="/app/payment/checkout" error_location="rn_ErrorLocation" />
                        </div>
                        <div class="rn_Hidden">
                            <fieldset>
                                <legend>
                        ...
                        <!-- <rn:widget path="input/FormSubmit" label_button="Donate in Support" on_success_url="/app/payment/checkout/skip_confirm_donor/1" error_location="rn_ErrorLocation" /> -->
                        <div>
                        <rn:widget path="input/DonationSubmit" label_button="#rn:msg:CUSTOM_MSG_CP_DONATE_NOW#" on_success_url="/app/payment/success" error_location="rn_ErrorLocation" challenge_location="rn_Challenge" challenge_required="true" />  
                        </div>
                        <!-- </form> -->
                    </div>
                </rn:condition>
                    ...
                    <div id="rn_PageContent" class="rn_Account rn_LoginForm">
                        <div class="rn_Padding">
                            ...
                            <div class="rn_Column rn_CreateContactFormOnCheckout">
                                ...
                                <div>
                                    <!-- <rn:widget path="custom/eventus/ajaxDonateFormSubmit" label_button="#rn:msg:CUSTOM_MSG_CP_DONATE_NOW#" on_success_url="/app/payment/success" error_location="rn_ErrorLocation" challenge_required="true"/> -->
                                    <rn:widget path="input/DonationSubmit" label_button="#rn:msg:CUSTOM_MSG_CP_DONATE_NOW#" on_success_url="/app/payment/success" error_location="rn_ErrorLocation" challenge_location="rn_Challenge" challenge_required="true" />                                    
                                </div>
                                <!-- </form> -->
                            </div>
    ...
    <div>
        ...
        <p>#rn:msg:CUSTOM_MSG_CP_DONATE_OUR_INFO#</p>
    </div>
</div>