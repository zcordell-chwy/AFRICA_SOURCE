...
<div class="accountSubNav">
        <ul>
            ...
            <li>
                <rn:widget path="navigation/NavigationTab2" label_tab="Pledges" link="/app/account/pledges/c_id/#rn:php:$this->data['contactId']#" pages="account/pledges "/>
            </li>
            <li>
            ...
            <li>
                <rn:widget path="navigation/NavigationTab2" label_tab="Receipts" link="/app/account/communications/c_id/#rn:php:$this->data['contactId']#" pages="account/communications"/>
            </li>
            <li>
             ...
             <li>
                <rn:widget path="navigation/NavigationTab2" label_tab="Donation History" link="/app/account/overview/" pages="account/overview "/>
            </li>
            <li>
            ...
            <li>
                <?  
                    $this->data['children'] = $this->CI->model('custom/sponsor_model')->getSponsoredChildren($this->data['contactId']);
