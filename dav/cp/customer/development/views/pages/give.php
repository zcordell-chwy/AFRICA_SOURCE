...
<div id="rn_PageContent" class="rn_GiveGiftPage">
	<rn:widget path="custom/aesthetic/ImageBannerTitle" banner_title="Gift for Child" banner_img_path="/euf/assets/images/banners/gift.jpg" />
	...
	<div class="rn_AfricaNewLifeLayoutLeftColumn">
		<rn:widget path="custom/display/GiftPopupGallery" 
			title="#rn:msg:CUSTOM_MSG_cp_give_page_gift_popup_gallery_title#" 
			description="#rn:msg:CUSTOM_MSG_cp_give_page_popup_gallery_description#".
			preload_item_popup_data="true"
			columns="4"
			rows="4"
			loading_msg="Loading gift gallery..." />
	</div>
