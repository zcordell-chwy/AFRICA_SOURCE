<rn:meta title="#rn:msg:SUPPORT_LOGIN_HDG#" template="mobile.php" login_required="false" redirect_if_logged_in="account/questions/list" />
...
<section id="rn_PageContent" class="rn_LoginForm">
    <div id="rn_ThirdPartyLogin" class="rn_Padding">
        ...
        <rn:widget path="login/OpenLogin" display_in_dialog="true"/> <? /* Attributes Default to Facebook */ ?>
        ...
        <rn:widget path="login/OpenLogin" controller_endpoint="/ci/openlogin/openid/authorize" label_service_button="AOL" openid="true" preset_openid_url="https://openid.aol.com/[username]" openid_placeholder="[#rn:msg:YOUR_AOL_USERNAME_LBL#]" label_process_explanation="#rn:msg:YOULL_AOL_LOG_AOL_VERIFY_SEND_YOULL_MSG#" label_login_button="#rn:msg:LOG_IN_USING_AOL_LBL#" display_in_dialog="true"/>
        <rn:widget path="login/OpenLogin" controller_endpoint="/ci/openlogin/openid/authorize" label_service_button="MyOpenID" openid="true" preset_openid_url="https://[username].myopenid.com" openid_placeholder="[#rn:msg:YOUR_MYOPENID_USERNAME_LBL#]" label_process_explanation="#rn:msg:YOULL_MYOPENID_LOG_MYOPENID_VERIFY_MSG#" label_login_button="#rn:msg:LOG_IN_USING_MYOPENID_LBL#" display_in_dialog="true"/>
        ...
        <rn:widget path="login/OpenLogin" controller_endpoint="/ci/openlogin/openid/authorize" label_service_button="OpenID" openid="true" openid_placeholder="https://[provider]" label_process_explanation="#rn:msg:YOULL_OPENID_PROVIDER_LOG_PROVIDER_MSG#" label_login_button="#rn:msg:LOG_IN_USING_OPENID_LBL#" display_in_dialog="true"/> -->
    </div>
