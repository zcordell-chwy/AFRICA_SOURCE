...
class items extends  \RightNow\Models\Base
{
    ...
    public function removeItemFromCart($sessionId, $cartId)
    {
        try {
            ...
            $this->CI->model('custom/log_model')->log(__FILE__, __FUNCTION__, 0, 0, __LINE__,  print_r($e, true), "CartStorage");
        }
    ...
    public function getSingleDonationItem($f_id)
    {
        ...
        if ($f_id > 0) {
            ...
            try {
                ...
                $this->CI->model('custom/log_model')->log(__FILE__, __FUNCTION__, 0, 0, __LINE__,  print_r($e->getMessage(), true), "Items");
