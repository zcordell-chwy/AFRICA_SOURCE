RightNow.namespace("Custom.Widgets.eventus.ajaxFormSubmit");
var childID = null;
Custom.Widgets.eventus.ajaxFormSubmit = RightNow.Widgets.extend({
  /**
   * Widget constructor.
   */
  constructor: function () {
    ...
    this.childID = this.data.js.child_id;
