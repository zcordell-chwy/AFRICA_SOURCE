                    ...
                    <div class="rn_GiftPopupGalleryItemPopupRightColumn">
                        ...
                        <div class="rn_GiftPopupGalleryItemPopupAddToCartForm">
                            ...
                            <? else : ?>
                                ...
                                <?if ($this->data['cospon']):?>
                                    <div class="rn_GiftPopupGalleryItemPopupInputContainer" data-field="amount" data-children-count="1">
                                        <span class="rn_GiftPopupGalleryItemPopupAddToCartFormLabel">Amount: $</span>
                                        <input class="rn_GiftPopupGalleryItemPopupQuantity" style="width:80px;" type="number" value="<?=$this->data['attrs']['default_charge_amount']?>">
